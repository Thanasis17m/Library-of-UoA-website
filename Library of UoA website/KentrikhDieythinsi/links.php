...
<html>
	<head>
		...
		<title>Σύνδεσμοι-Βιβλιοθήκη ΕΚΠΑ</title>
		...
		<div id="wrapper">
			...
			<div id="content">
				...
				<div id="links_msg">
					...
					<p>.... ..... ....</p>
					<hr>
					<h5>Σύνδεσμοι Γενικού Ενδιαφέροντος</h5>
					<p>.... ..... ....</p>
					<hr>
					<h5>Σύνδεσμοι για Αναγνώσματα</h5>
					<p>.... ..... ....</p>
					<hr>
					<h5>Σύνδεσμοι για Βιβλιοθήκες Εξωτερικού</h5>
					<p>.... ..... ....</p>
					<hr>
					<h5>Σύνδεσμοι για Βιβλιοθήκες Εσωτερικού</h5>
					<p>.... ..... ....</p>
					<hr>
					<h5>Σύνδεσμοι για Οργανισμούς & Ερευνητικά Ινστιτούτα</h5>
					<p>.... ..... ....</p>
					<hr>
					<h5>Σύνδεσμοι ΤΕΙ</h5>
					<p>.... ..... ....</p>
