			...
			<div id="content">
				...
				<div id="lib_search">
					...
					<?php 
						...
						//The libraries table has these columns: id,library name,address,rental_duration,department,the link to the library page,central_library,opening_hours,email

						if( $_GET["search_parameter1"]=="Τμήμα"){
							//echo "you chose".$_GET["search_parameter1"];
							$query = $query." department LIKE '%".$_GET["search"]."%'";

						}
						else if( $_GET["search_parameter1"]=="Διεύθυνση"){
							//echo "you chose".$_GET["search_parameter1"];
							$query = $query." address LIKE '%".$_GET["search"]."%'";

						}
						//echo "You gave the query  ".$query;
						...
						$result_num=0;
						//echo "num of rows is: ".$num_of_rows;
