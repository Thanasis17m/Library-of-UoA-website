	...
	<head>
 	 ...
 	 <?php 
			...
			if(isset($_POST['email']) && isset($_POST['password'])){
				...
				$user_result = mysqli_fetch_all($res);
				...
				<?php }
					...
					$_SESSION['id'] = $user_result[0][0];
					$_SESSION['name']=$user_result[0][1]; 
					?>
			...
			<div id="navbar">
				<ul>
					  ...
					  <div class="dropdown">
					  		...
					  		<div class="dropdown-content">
					  			<a href="KentrikhDieythinsi/announcements.html">Ανακοινώσεις</a>
				...
				<div id="box">
					...
					<?php 
						if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == TRUE){
							?>
							<h4>
								Καλώς ήρθες, <?php echo $_SESSION['name'] ?> !!
							</h4>
							<?php
						}
							...
							<h4>
								...
								Παρακαλώ εισάγετε σωστά στοιχεία σύνδεσης.
							</h4>
					<?php }
					?>
